...
public class TimetableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new FirestoreRecyclerAdapter<TimetableModel, TimetableFragment.TimetableViewHolder>(options) {
            @NonNull
            @NotNull
            @Override
            public TimetableFragment.TimetableViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_row_timetable, parent,false);
                return new TimetableFragment.TimetableViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull @NotNull TimetableFragment.TimetableViewHolder holder, int position, @NonNull TimetableModel model) {
